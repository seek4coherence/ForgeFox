 ...
 *
 * This class manages the state for the marketplace view in the ForgeFox extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the ForgeFox extensions interface
...
import { MarketplaceItem, MarketplaceInstalledMetadata } from "@forgefox/types"
