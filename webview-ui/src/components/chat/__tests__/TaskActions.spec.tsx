import type { HistoryItem } from "@forgefox/types"
	...
	useTranslation: () => ({
		t: (key: string) => {
			const translations: Record<string, string> = {
				...
				"chat:task.connectToCloudDescription": "Sign in to ForgeFox Cloud to share tasks",
				...
				"cloud:cloudBenefitsTitle": "Connect to ForgeFox Cloud",
...
describe("TaskActions", () => {
	...
	describe("Unauthenticated User Login Flow", () => {
		...
		it("shows connect to cloud option when not authenticated", () => {
			...
			expect(screen.getByText("Connect to ForgeFox Cloud")).toBeInTheDocument()
