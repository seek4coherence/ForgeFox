...
import { validateSkillName as validateSkillNameShared, SkillNameValidationError } from "@forgefox/types"
...
/**
 * Validate skill name using shared validation from @forgefox/types.
