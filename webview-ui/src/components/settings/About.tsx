				...
				<SearchableSetting
					...
					<p className="text-vscode-descriptionForeground text-sm mt-0">
						<Trans
							...
							components={{
								privacyLink: <VSCodeLink href="https://forgefox.com/privacy" />,
							}}
						/>
					</p>
				</SearchableSetting>
				...
				<div className="flex flex-col gap-3">
					<div className="flex items-start gap-2">
						...
						<span>
							...
							<VSCodeLink href="https://github.com/ForgeFoxInc/ForgeFox/issues/new?template=bug_report.yml">
					...
					<div className="flex items-start gap-2">
						...
						<span>
							...
							<VSCodeLink href="https://github.com/ForgeFoxInc/ForgeFox/issues/new?template=feature_request.yml">
					...
					<div className="flex items-start gap-2">
						...
						<span>
							...
							<VSCodeLink href="https://github.com/ForgeFoxInc/ForgeFox/security/policy">
					...
					<div className="flex items-start gap-2">
						...
						<span>
							...
							<VSCodeLink href="mailto:support@BusinessEdgeAnalytics.com">support@BusinessEdgeAnalytics.com</VSCodeLink>
						</span>
					</div>
					<div className="flex items-start gap-2">
						...
						<span>
							<Trans
								...
								components={{
									redditLink: <VSCodeLink href="https://reddit.com/r/ForgeFox" />,
									discordLink: <VSCodeLink href="https://discord.gg/forgefox" />,
								}}
							/>
						</span>
					</div>
