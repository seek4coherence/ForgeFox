...
import { CodeActionName, CodeActionId } from "@forgefox/types"
...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with ForgeFox",
	FIX: "Fix with ForgeFox",
	IMPROVE: "Improve with ForgeFox",
	ADD_TO_CONTEXT: "Add to ForgeFox",
	NEW_TASK: "New ForgeFox Task",
} as const
