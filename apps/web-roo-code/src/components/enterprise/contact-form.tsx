...
export function ContactForm({ formType, buttonText, buttonClassName }: ContactFormProps) {
	...
	const formDescription =
		formType === "early-access"
			? "Fill out the form below to collaborate in shaping ForgeFox's enterprise solution."
			: "Fill out the form below to see ForgeFox's enterprise capabilities in action."
