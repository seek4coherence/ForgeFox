...
const faqs: FAQItem[] = [
	{
		question: "What exactly is ForgeFox?",
		answer: (
			<>
				ForgeFox is an open-source, AI-powered coding assistant that runs in VS Code. It goes beyond simple
	...
	{
		question: "How does ForgeFox differ from Copilot, Cursor, or Windsurf?",
		answer: (
			<>
				ForgeFox is <strong>open-source and fully customizable</strong>, letting you integrate any AI model you
				...
				browser, and handle deeper tasks. And you&apos;re always in control: ForgeFox is{" "}
	...
	{
		question: "Is ForgeFox really free?",
		answer: (
			<>
				Yes! ForgeFox is completely free and open-source. You&apos;ll only pay for the AI model usage if you use
	...
	},
	{
		...
		answer: (
			<>
				Yes. Because ForgeFox is an extension in your local VS Code, your code never leaves your machine unless
				you connect to an external AI API. Even then, you control exactly what is sent to the AI model. You can
				use tools like .rooignore to exclude sensitive files, and you can also run ForgeFox with offline/local
				models for full privacy.
			</>
		),
	},
	{
		question: "Which AI models does ForgeFox support?",
		answer: (
			<>
				ForgeFox is fully model-agnostic, giving you the flexibility to work with whatever AI models you prefer.
				...
				connect any other model that follows ForgeFox&apos;s Model Context Protocol (MCP).
			</>
		),
	},
	{
		question: "Does ForgeFox support my programming language?",
		answer: (
			<>
				Likely yes! ForgeFox supports a wide range of languages—Python, Java, C#, JavaScript/TypeScript, Go,
	...
	},
	{
		...
		answer: (
			<>
				...
				<a
					href="https://docs.forgefox.com/tutorial-videos"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
	...
	},
	{
		...
		answer: (
			<>
				Absolutely. ForgeFox uses efficient strategies (like partial-file analysis, summarization, or
				...
				<Link href="/enterprise" className="text-primary underline-offset-4 hover:underline">
					Learn more about ForgeFox for enterprise.
				</Link>
			</>
		),
	},
	{
		...
		answer: (
			<>
				Yes. ForgeFox was built for enterprise environments. You can self-host AI models or use your own trusted
				provider. All file changes and commands go through permission gating, so nothing runs without your
				approval. And because ForgeFox is fully open-source, it&apos;s auditable—you can review exactly how it
				works before deploying it.{" "}
				<a
					href="https://forgefox.com/enterprise"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					Learn more about ForgeFox for enterprise.
	...
	{
		question: "Can ForgeFox run commands and tests automatically?",
		answer: (
			<>
				Yes! One of ForgeFox&apos;s biggest strengths is its ability to execute commands—always optional and
	...
	},
	{
		...
		answer: (
			<>
				ForgeFox shines for both serious enterprise development and casual &quot;vibe coding.&quot; You can ask
	...
	{
		question: "Can I contribute to ForgeFox?",
		answer: (
			<>
				Yes, please do! ForgeFox is open-source on{" "}
				<a
					href="https://github.com/ForgeFoxInc/ForgeFox"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					GitHub
				...
				<a
					href="https://discord.gg/forgefox"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					Discord
				...
				and{" "}
				<a
					href="https://reddit.com/r/ForgeFox"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					Reddit
	...
	},
	{
		...
		answer: (
			<>
				...
				<a
					href="https://www.youtube.com/@ForgeFoxYT"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					YouTube
				...
				<div className="mx-auto mb-24 max-w-3xl text-center">
					<motion.div
						...
						<p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
							Everything you need to know about ForgeFox and how it can transform your development
							workflow.
						</p>
					</motion.div>
				</div>
