import { type Keys, type ForgeFoxSettings, GLOBAL_SETTINGS_KEYS, PROVIDER_SETTINGS_KEYS } from "@forgefox/types"

import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui"

export const FORGEFOX_SETTINGS_KEYS = [
	...new Set([...GLOBAL_SETTINGS_KEYS, ...PROVIDER_SETTINGS_KEYS]),
] as Keys<ForgeFoxSettings>[]

type SettingsDiffProps = {
	defaultSettings: ForgeFoxSettings
	customSettings: ForgeFoxSettings
}
	...
	return (
		<div className="border rounded-sm">
			<Table>
				...
				<TableBody>
					{FORGEFOX_SETTINGS_KEYS.map((key) => {
