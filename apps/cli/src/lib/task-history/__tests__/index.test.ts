import { readTaskSessionsFromStoragePath } from "@forgefox/core/cli"
...
vi.mock("@forgefox/core/cli", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@forgefox/core/cli")>()
	return {
		...actual,
