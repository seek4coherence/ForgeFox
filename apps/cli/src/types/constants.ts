import { reasoningEffortsExtended } from "@forgefox/types"
...
export const AUTH_BASE_URL = process.env.ROO_AUTH_BASE_URL ?? "https://app.forgefox.com"

export const SDK_BASE_URL = process.env.ROO_SDK_BASE_URL ?? "https://cloud-api.forgefox.com"
