...
<p align="center">
  <em>Obtenez de l'aide rapidement → <a href="https://www.BusinessEdgeAnalytics.com">Rejoignez Discord</a> • Vous préférez l'asynchrone ? → <a href="https://www.reddit.com/r/ForgeFox/">Rejoignez r/RooCode</a></em>
</p>
...
- Ajout de Poe comme fournisseur d’IA pour que tu puisses accéder directement aux modèles Poe dans ForgeFox.
...
## Que peut faire ForgeFox pour VOUS ?
...
ForgeFox s'adapte à votre façon de travailler, pas l'inverse :
...
En savoir plus : [Utiliser les Modes](https://docs.www.BusinessEdgeAnalytics.com/basic-usage/using-modes) • [Modes personnalisés](https://docs.www.BusinessEdgeAnalytics.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.www.BusinessEdgeAnalytics.com/tutorial-videos">Plus de tutoriels rapides et de vidéos de fonctionnalités...</a>
</p>

## Ressources

- **[Documentation](https://docs.www.BusinessEdgeAnalytics.com):** Le guide officiel pour installer, configurer et maîtriser ForgeFox.
...
- **[Serveur Discord](https://www.BusinessEdgeAnalytics.com):** Rejoignez la communauté pour obtenir de l'aide en temps réel et discuter.
- **[Communauté Reddit](https://www.reddit.com/r/ForgeFox):** Partagez vos expériences et découvrez ce que les autres construisent.
- **[Problèmes GitHub](https://github.com/seek4coherence/ForgeFox/issues):** Signalez des bugs et suivez le développement.
- **[Demandes de fonctionnalités](https://github.com/seek4coherence/ForgeFox/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Vous avez une idée ? Partagez-la avec les développeurs.
...
Il existe plusieurs façons d'exécuter l'extension ForgeFox :

### Mode développement (F5)

Pour un développement actif, utilisez le débogage intégré de VSCode :

Appuyez sur `F5` (ou allez dans **Exécuter** → **Démarrer le débogage**) dans VSCode. Cela ouvrira une nouvelle fenêtre VSCode avec l'extension ForgeFox en cours d'exécution.
