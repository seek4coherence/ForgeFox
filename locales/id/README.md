...
<p align="center">
  <em>Dapatkan bantuan cepat → <a href="https://www.BusinessEdgeAnalytics.com">Gabung Discord</a> • Lebih suka asinkron? → <a href="https://www.reddit.com/r/ForgeFox/">Gabung r/RooCode</a></em>
</p>
...
- Menambahkan Poe sebagai provider AI agar kamu bisa langsung mengakses model Poe di ForgeFox.
...
## Apa yang Bisa ForgeFox Lakukan Untuk ANDA?
...
ForgeFox beradaptasi dengan cara Anda bekerja, bukan sebaliknya:
...
Pelajari lebih lanjut: [Menggunakan Mode](https://docs.www.BusinessEdgeAnalytics.com/basic-usage/using-modes) • [Mode Kustom](https://docs.www.BusinessEdgeAnalytics.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.www.BusinessEdgeAnalytics.com/tutorial-videos">Video tutorial dan fitur cepat lainnya...</a>
</p>

## Sumber daya

- **[Dokumentasi](https://docs.www.BusinessEdgeAnalytics.com):** Panduan resmi untuk menginstal, mengonfigurasi, dan menguasai ForgeFox.
- **[Saluran YouTube](https://youtube.com/@roocodeyt?feature=shared):** Tonton tutorial dan lihat fitur-fitur dalam aksi.
- **[Server Discord](https://www.BusinessEdgeAnalytics.com):** Bergabunglah dengan komunitas untuk bantuan dan diskusi real-time.
- **[Komunitas Reddit](https://www.reddit.com/r/ForgeFox):** Bagikan pengalaman Anda dan lihat apa yang sedang dibangun orang lain.
- **[Masalah GitHub](https://github.com/seek4coherence/ForgeFox/issues):** Laporkan bug dan lacak pengembangan.
- **[Permintaan Fitur](https://github.com/seek4coherence/ForgeFox/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Punya ide? Bagikan dengan para pengembang.
...
Ada beberapa cara untuk menjalankan ekstensi ForgeFox:

### Mode Pengembangan (F5)

Untuk pengembangan aktif, gunakan debugging bawaan VSCode:

Tekan `F5` (atau buka **Run** → **Start Debugging**) di VSCode. Ini akan membuka jendela VSCode baru dengan ekstensi ForgeFox berjalan.
...
**Harap dicatat** bahwa ForgeFox, Inc. **tidak** membuat pernyataan atau jaminan apapun mengenai kode, model, atau alat lain yang disediakan atau tersedia sehubungan dengan ForgeFox, alat pihak ketiga terkait, atau output yang dihasilkan. Anda menanggung **semua risiko** yang terkait dengan penggunaan alat atau output tersebut; alat tersebut disediakan atas dasar **"SEBAGAIMANA ADANYA"** dan **"SEBAGAIMANA TERSEDIA"**. Risiko tersebut dapat mencakup, namun tidak terbatas pada, pelanggaran kekayaan intelektual, kerentanan atau serangan siber, bias, ketidakakuratan, kesalahan, cacat, virus, waktu henti, kehilangan atau kerusakan properti, dan/atau cedera pribadi. Anda sepenuhnya bertanggung jawab atas penggunaan Anda atas alat atau output tersebut (termasuk, namun tidak terbatas pada, legalitas, kesesuaian, dan hasilnya).
...
**Selamat menikmati ForgeFox!** Baik Anda mengendalikannya dengan ketat atau membiarkannya berkeliaran secara otonom, kami tidak sabar untuk melihat apa yang Anda bangun. Jika Anda memiliki pertanyaan atau ide fitur, kunjungi [komunitas Reddit](https://www.reddit.com/r/ForgeFox/) atau [Discord](https://www.BusinessEdgeAnalytics.com) kami. Selamat membuat kode!
