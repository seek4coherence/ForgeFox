...
<p align="center">
  <em>Obtén ayuda rápido → <a href="https://www.BusinessEdgeAnalytics.com">Únete a Discord</a> • ¿Prefieres asíncrono? → <a href="https://www.reddit.com/r/ForgeFox/">Únete a r/RooCode</a></em>
</p>
...
- Se añadió Poe como proveedor de IA para que puedas acceder directamente a los modelos de Poe en ForgeFox.
...
## ¿Qué puede hacer ForgeFox por TI?
...
ForgeFox se adapta a tu forma de trabajar, no al revés:
...
Más info: [Usar Modos](https://docs.www.BusinessEdgeAnalytics.com/basic-usage/using-modes) • [Modos Personalizados](https://docs.www.BusinessEdgeAnalytics.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.www.BusinessEdgeAnalytics.com/tutorial-videos">Más tutoriales rápidos y vídeos de funcionalidades...</a>
</p>

## Recursos

- **[Documentación](https://docs.www.BusinessEdgeAnalytics.com):** La guía oficial para instalar, configurar y dominar ForgeFox.
- **[Canal de YouTube](https://youtube.com/@roocodeyt?feature=shared):** Mira tutoriales y ve las funcionalidades en acción.
- **[Servidor de Discord](https://www.BusinessEdgeAnalytics.com):** Únete a la comunidad para obtener ayuda y discutir en tiempo real.
- **[Comunidad de Reddit](https://www.reddit.com/r/ForgeFox):** Comparte tus experiencias y ve lo que otros están construyendo.
- **[Incidencias de GitHub](https://github.com/seek4coherence/ForgeFox/issues):** Reporta errores y sigue el desarrollo.
- **[Solicitudes de funcionalidades](https://github.com/seek4coherence/ForgeFox/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** ¿Tienes una idea? Compártela con los desarrolladores.
...
Hay varias formas de ejecutar la extensión ForgeFox:

### Modo de desarrollo (F5)

Para el desarrollo activo, utiliza la depuración integrada de VSCode:

Presiona `F5` (o ve a **Ejecutar** → **Iniciar depuración**) en VSCode. Esto abrirá una nueva ventana de VSCode con la extensión ForgeFox en ejecución.
