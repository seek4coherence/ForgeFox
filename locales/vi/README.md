...
<p align="center">
  <em>Nhận trợ giúp nhanh → <a href="https://www.BusinessEdgeAnalytics.com">Tham gia Discord</a> • Thích không đồng bộ? → <a href="https://www.reddit.com/r/ForgeFox/">Tham gia r/RooCode</a></em>
</p>
...
- Đã thêm Poe làm nhà cung cấp AI để bạn có thể truy cập trực tiếp các model Poe trong ForgeFox.
...
## ForgeFox có thể làm gì cho BẠN?
...
ForgeFox thích ứng với cách bạn làm việc, chứ không phải ngược lại:
...
Xem thêm: [Sử dụng Chế độ](https://docs.www.BusinessEdgeAnalytics.com/basic-usage/using-modes) • [Chế độ tùy chỉnh](https://docs.www.BusinessEdgeAnalytics.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.www.BusinessEdgeAnalytics.com/tutorial-videos">Thêm video hướng dẫn và tính năng nhanh...</a>
</p>

## Tài nguyên

- **[Tài liệu](https://docs.www.BusinessEdgeAnalytics.com):** Hướng dẫn chính thức để cài đặt, cấu hình và sử dụng thành thạo ForgeFox.
- **[Kênh YouTube](https://youtube.com/@roocodeyt?feature=shared):** Xem các video hướng dẫn và các tính năng đang hoạt động.
- **[Máy chủ Discord](https://www.BusinessEdgeAnalytics.com):** Tham gia cộng đồng để được trợ giúp và thảo luận trong thời gian thực.
- **[Cộng đồng Reddit](https://www.reddit.com/r/ForgeFox):** Chia sẻ kinh nghiệm của bạn và xem những người khác đang xây dựng gì.
- **[Vấn đề trên GitHub](https://github.com/seek4coherence/ForgeFox/issues):** Báo cáo lỗi và theo dõi quá trình phát triển.
- **[Yêu cầu tính năng](https://github.com/seek4coherence/ForgeFox/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Có ý tưởng? Hãy chia sẻ với các nhà phát triển.
...
Có một số cách để chạy phần mở rộng ForgeFox:

### Chế độ phát triển (F5)

Để phát triển tích cực, hãy sử dụng tính năng gỡ lỗi tích hợp của VSCode:

Nhấn `F5` (hoặc vào **Run** → **Start Debugging**) trong VSCode. Thao tác này sẽ mở một cửa sổ VSCode mới với phần mở rộng ForgeFox đang chạy.
...
**Thưởng thức ForgeFox!** Dù bạn giữ nó trong tầm kiểm soát chặt chẽ hay để nó tự do hoạt động, chúng tôi rất nóng lòng muốn xem bạn sẽ xây dựng được gì. Nếu bạn có câu hỏi hoặc ý tưởng về tính năng, hãy ghé qua [cộng đồng Reddit](https://www.reddit.com/r/ForgeFox/) hoặc [Discord](https://www.BusinessEdgeAnalytics.com) của chúng tôi. Chúc bạn viết mã vui vẻ!
