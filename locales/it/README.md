...
<p align="center">
  <em>Ottieni aiuto velocemente → <a href="https://www.BusinessEdgeAnalytics.com">Unisciti a Discord</a> • Preferisci l'asincrono? → <a href="https://www.reddit.com/r/ForgeFox/">Unisciti a r/RooCode</a></em>
</p>
...
- Aggiunto Poe come provider AI così puoi accedere direttamente ai modelli Poe in ForgeFox.
...
ForgeFox si adatta al tuo modo di lavorare, non il contrario:
...
Scopri di più: [Usare le Modalità](https://docs.www.BusinessEdgeAnalytics.com/basic-usage/using-modes) • [Modalità personalizzate](https://docs.www.BusinessEdgeAnalytics.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.www.BusinessEdgeAnalytics.com/tutorial-videos">Altri video tutorial e funzionalità rapide...</a>
</p>

## Risorse

- **[Documentazione](https://docs.www.BusinessEdgeAnalytics.com):** La guida ufficiale per installare, configurare e padroneggiare ForgeFox.
- **[Canale YouTube](https://youtube.com/@roocodeyt?feature=shared):** Guarda i tutorial e le funzionalità in azione.
- **[Server Discord](https://www.BusinessEdgeAnalytics.com):** Unisciti alla community per aiuto e discussioni in tempo reale.
- **[Comunità Reddit](https://www.reddit.com/r/ForgeFox):** Condividi le tue esperienze e guarda cosa stanno costruendo gli altri.
- **[Problemi GitHub](https://github.com/seek4coherence/ForgeFox/issues):** Segnala bug e tieni traccia dello sviluppo.
- **[Richieste di funzionalità](https://github.com/seek4coherence/ForgeFox/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Hai un'idea? Condividila con gli sviluppatori.
...
Ci sono diversi modi per eseguire l'estensione ForgeFox:

### Modalità di sviluppo (F5)

Per lo sviluppo attivo, usa il debug integrato di VSCode:

Premi `F5` (o vai su **Esegui** → **Avvia debug**) in VSCode. Si aprirà una nuova finestra di VSCode con l'estensione ForgeFox in esecuzione.
