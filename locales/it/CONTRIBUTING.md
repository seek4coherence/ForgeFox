...
### 3. Unisciti alla community di ForgeFox

- **Principale:** Unisciti al nostro [Discord](https://discord.gg/roocode) e invia un DM a **Hannes Rudolph (`hrudolph`)**.
- **Alternativa:** I contributori esperti possono interagire direttamente tramite i [progetti GitHub](https://github.com/orgs/seek4coherence/projects/1).
...
- **Controlla le issue esistenti**: cerca nelle [issue di GitHub](https://github.com/seek4coherence/ForgeFox/issues).
...
- Controlla il [progetto GitHub](https://github.com/orgs/seek4coherence/projects/1) per le issue "Issue [Non assegnata]".
- Per la documentazione, visita [ForgeFox Docs](https://github.com/seek4coherence/ForgeFox-Docs).

### Segnalazione di bug

- Controlla prima le segnalazioni esistenti.
- Crea un nuovo bug utilizzando il [modello "Segnalazione di bug"](https://github.com/seek4coherence/ForgeFox/issues/new/choose) con:
    - Passaggi di riproduzione chiari e numerati
    - Risultato previsto vs effettivo
    - Versione di ForgeFox (obbligatoria); provider/modello di intelligenza artificiale se pertinente
- **Problemi di sicurezza**: segnala in privato tramite [avvisi di sicurezza](https://github.com/seek4coherence/ForgeFox/security/advisories/new).
...
Contribuendo, accetti che i tuoi contributi siano concessi in licenza con la licenza Apache 2.0, in coerenza con la licenza di ForgeFox.
