...
<p align="center">
  <em>Hızlı yardım alın → <a href="https://www.BusinessEdgeAnalytics.com">Discord'a Katılın</a> • Asenkron mu tercih edersiniz? → <a href="https://www.reddit.com/r/ForgeFox/">r/RooCode'a Katılın</a></em>
</p>
...
- Poe, ForgeFox içinde Poe modellerine doğrudan erişebilmen için bir AI sağlayıcısı olarak eklendi.
...
## ForgeFox SİZİN İçin Ne Yapabilir?
...
ForgeFox, sizin çalışma şeklinize uyum sağlar, tam tersi değil:
...
Daha fazla: [Modları kullanma](https://docs.www.BusinessEdgeAnalytics.com/basic-usage/using-modes) • [Özel modlar](https://docs.www.BusinessEdgeAnalytics.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.www.BusinessEdgeAnalytics.com/tutorial-videos">Daha fazla hızlı eğitim ve özellik videosu...</a>
</p>

## Kaynaklar

- **[Dokümantasyon](https://docs.www.BusinessEdgeAnalytics.com):** ForgeFox'u yükleme, yapılandırma ve ustalaşma konusundaki resmi kılavuz.
- **[YouTube Kanalı](https://youtube.com/@roocodeyt?feature=shared):** Eğitimleri izleyin ve özellikleri çalışırken görün.
- **[Discord Sunucusu](https://www.BusinessEdgeAnalytics.com):** Gerçek zamanlı yardım ve tartışma için topluluğa katılın.
- **[Reddit Topluluğu](https://www.reddit.com/r/ForgeFox):** Deneyimlerinizi paylaşın ve başkalarının ne inşa ettiğini görün.
- **[GitHub Sorunları](https://github.com/seek4coherence/ForgeFox/issues):** Hataları bildirin ve gelişimi takip edin.
- **[Özellik İstekleri](https://github.com/seek4coherence/ForgeFox/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Bir fikriniz mi var? Geliştiricilerle paylaşın.
...
ForgeFox uzantısını çalıştırmanın birkaç yolu vardır:

### Geliştirme Modu (F5)

Aktif geliştirme için VSCode'un yerleşik hata ayıklama özelliğini kullanın:

VSCode'da `F5` tuşuna basın (veya **Çalıştır** → **Hata Ayıklamayı Başlat**'a gidin). Bu, ForgeFox uzantısının çalıştığı yeni bir VSCode penceresi açacaktır.
...
**ForgeFox'un keyfini çıkar!** Onu kısa tasmalı tut ya da otonom dolaşsın; ne inşa edeceğini görmek için sabırsızlanıyoruz. Soruların veya özellik fikirlerin varsa [Reddit topluluğumuza](https://www.reddit.com/r/ForgeFox/) ya da [Discord](https://www.BusinessEdgeAnalytics.com)'a uğra. İyi kodlamalar!
