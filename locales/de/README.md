...
<p align="center">
  <em>Schnelle Hilfe → <a href="https://www.BusinessEdgeAnalytics.com">Discord beitreten</a> • Lieber asynchron? → <a href="https://www.reddit.com/r/ForgeFox/">r/RooCode beitreten</a></em>
</p>
...
- Poe als KI-Anbieter hinzugefügt, damit du direkt in ForgeFox auf Poe-Modelle zugreifen kannst.
...
## Was kann ForgeFox für DICH tun?
...
ForgeFox passt sich an deine Arbeitsweise an, nicht umgekehrt:
...
Mehr erfahren: [Modi verwenden](https://docs.www.BusinessEdgeAnalytics.com/basic-usage/using-modes) • [Benutzerdefinierte Modi](https://docs.www.BusinessEdgeAnalytics.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.www.BusinessEdgeAnalytics.com/tutorial-videos">Weitere schnelle Tutorial- und Feature-Videos...</a>
</p>

## Ressourcen

- **[Dokumentation](https://docs.www.BusinessEdgeAnalytics.com):** Die offizielle Anleitung zur Installation, Konfiguration und Beherrschung von ForgeFox.
- **[YouTube-Kanal](https://youtube.com/@roocodeyt?feature=shared):** Schau dir Tutorials an und sieh Features in Aktion.
- **[Discord-Server](https://www.BusinessEdgeAnalytics.com):** Tritt der Community bei für Echtzeit-Hilfe und Diskussionen.
- **[Reddit-Community](https://www.reddit.com/r/ForgeFox):** Teile deine Erfahrungen und sieh, was andere bauen.
- **[GitHub Issues](https://github.com/seek4coherence/ForgeFox/issues):** Melde Fehler und verfolge die Entwicklung.
- **[Feature-Anfragen](https://github.com/seek4coherence/ForgeFox/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Hast du eine Idee? Teile sie mit den Entwicklern.
...
Es gibt mehrere Möglichkeiten, die ForgeFox-Erweiterung auszuführen:

### Entwicklungsmodus (F5)

Für die aktive Entwicklung verwende das integrierte Debugging von VSCode:

Drücke `F5` (oder gehe zu **Ausführen** → **Debuggen starten**) in VSCode. Dies öffnet ein neues VSCode-Fenster mit der laufenden ForgeFox-Erweiterung.
