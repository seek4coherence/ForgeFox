...
<p align="center">
  <em>Uzyskaj szybką pomoc → <a href="https://www.BusinessEdgeAnalytics.com">Dołącz do Discorda</a> • Wolisz asynchronicznie? → <a href="https://www.reddit.com/r/ForgeFox/">Dołącz do r/RooCode</a></em>
</p>
...
- Dodano Poe jako dostawcę AI, żebyś mógł bezpośrednio uzyskać dostęp do modeli Poe w ForgeFox.
...
## Co ForgeFox może zrobić dla CIEBIE?
...
ForgeFox dostosowuje się do Twojego sposobu pracy, a nie odwrotnie:
...
Więcej: [Korzystanie z trybów](https://docs.www.BusinessEdgeAnalytics.com/basic-usage/using-modes) • [Tryby niestandardowe](https://docs.www.BusinessEdgeAnalytics.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.www.BusinessEdgeAnalytics.com/tutorial-videos">Więcej szybkich filmów instruktażowych i prezentujących funkcje...</a>
</p>

## Zasoby

- **[Dokumentacja](https://docs.www.BusinessEdgeAnalytics.com):** Oficjalny przewodnik po instalacji, konfiguracji i opanowaniu ForgeFox.
- **[Kanał YouTube](https://youtube.com/@roocodeyt?feature=shared):** Oglądaj samouczki i zobacz funkcje w akcji.
- **[Serwer Discord](https://www.BusinessEdgeAnalytics.com):** Dołącz do społeczności, aby uzyskać pomoc i dyskutować w czasie rzeczywistym.
- **[Społeczność Reddit](https://www.reddit.com/r/ForgeFox):** Dziel się swoimi doświadczeniami i zobacz, co budują inni.
- **[Problemy na GitHub](https://github.com/seek4coherence/ForgeFox/issues):** Zgłaszaj błędy i śledź rozwój.
- **[Prośby o funkcje](https://github.com/seek4coherence/ForgeFox/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Masz pomysł? Podziel się nim z deweloperami.
...
Istnieje kilka sposobów na uruchomienie rozszerzenia ForgeFox:

### Tryb deweloperski (F5)

Do aktywnego programowania użyj wbudowanego debugowania VSCode:

Naciśnij `F5` (lub przejdź do **Uruchom** → **Rozpocznij debugowanie**) w VSCode. Otworzy to nowe okno VSCode z uruchomionym rozszerzeniem ForgeFox.
...
**Miłej zabawy z ForgeFox!** Trzymaj go na krótkiej smyczy albo pozwól działać autonomicznie — nie możemy się doczekać, co zbudujesz. Masz pytania lub pomysły na funkcje? Wpadnij na naszą [społeczność Reddit](https://www.reddit.com/r/ForgeFox/) lub [Discord](https://www.BusinessEdgeAnalytics.com). Miłego kodowania!
