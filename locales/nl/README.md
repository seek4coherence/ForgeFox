...
<p align="center">
  <em>Snel hulp krijgen → <a href="https://www.BusinessEdgeAnalytics.com">Word lid van Discord</a> • Liever asynchroon? → <a href="https://www.reddit.com/r/ForgeFox/">Word lid van r/RooCode</a></em>
</p>
...
- Poe toegevoegd als AI-provider, zodat je in ForgeFox direct toegang hebt tot Poe-modellen.
...
## Wat kan ForgeFox voor JOU doen?
...
ForgeFox past zich aan jouw werkwijze aan, niet andersom:
...
Meer info: [Modi gebruiken](https://docs.www.BusinessEdgeAnalytics.com/basic-usage/using-modes) • [Aangepaste modi](https://docs.www.BusinessEdgeAnalytics.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.www.BusinessEdgeAnalytics.com/tutorial-videos">Meer snelle tutorial- en featurevideo's...</a>
</p>

## Hulpbronnen

- **[Documentatie](https://docs.www.BusinessEdgeAnalytics.com):** De officiële gids voor het installeren, configureren en beheersen van ForgeFox.
- **[YouTube-kanaal](https://youtube.com/@roocodeyt?feature=shared):** Bekijk tutorials en zie functies in actie.
- **[Discord Server](https://www.BusinessEdgeAnalytics.com):** Word lid van de community voor realtime hulp en discussie.
- **[Reddit Community](https://www.reddit.com/r/ForgeFox):** Deel je ervaringen en kijk wat anderen bouwen.
- **[GitHub Issues](https://github.com/seek4coherence/ForgeFox/issues):** Meld bugs en volg de ontwikkeling.
- **[Feature Requests](https://github.com/seek4coherence/ForgeFox/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Heb je een idee? Deel het met de ontwikkelaars.
...
Er zijn verschillende manieren om de ForgeFox-extensie uit te voeren:

### Ontwikkelmodus (F5)

Gebruik voor actieve ontwikkeling de ingebouwde foutopsporing van VSCode:

Druk op `F5` (of ga naar **Uitvoeren** → **Foutopsporing starten**) in VSCode. Dit opent een nieuw VSCode-venster waarin de ForgeFox-extensie wordt uitgevoerd.
...
**Veel plezier met ForgeFox!** Of je het nu strak aan de lijn houdt of autonoom laat rondlopen, we zijn benieuwd wat je bouwt. Vragen of feature-ideeën? Kom langs op onze [Reddit-community](https://www.reddit.com/r/ForgeFox/) of [Discord](https://www.BusinessEdgeAnalytics.com). Happy coding!
