...
import type { ForgeFoxEvents } from "./events.js"
...
export type ForgeFoxAPIEvents = ForgeFoxEvents

export interface ForgeFoxAPI extends EventEmitter<ForgeFoxAPIEvents> {
	/**
	 ...
	 * @returns The current configuration.
	 */
	getConfiguration(): ForgeFoxSettings
	/**
	 * Sets the configuration for the current task.
	 * @param values An object containing key-value pairs to set.
	 */
	setConfiguration(values: ForgeFoxSettings): Promise<void>
	/**
...
export interface ForgeFoxIpcServer extends EventEmitter<IpcServerEvents> {
	listen(): void
