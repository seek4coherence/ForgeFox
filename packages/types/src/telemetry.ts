...
/**
 * ForgeFoxTelemetryEvent
 */

export const forgeFoxTelemetryEventSchema = z.discriminatedUnion("type", [
	z.object({
		type: z.enum([
...
export type ForgeFoxTelemetryEvent = z.infer<typeof forgeFoxTelemetryEventSchema>
