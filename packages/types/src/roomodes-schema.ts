...
export function generateRoomodesJsonSchema(): Record<string, unknown> {
	...
	jsonSchema["$id"] = "https://github.com/ForgeFoxInc/ForgeFox/blob/main/schemas/roomodes.json"
	jsonSchema["title"] = "ForgeFox Custom Modes"
	jsonSchema["description"] = "Schema for .roomodes configuration files used by ForgeFox to define custom modes."
